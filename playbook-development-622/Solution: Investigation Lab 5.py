...
def set_severity_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    playbook_solution__case_promotion_lab_5_1(container=container)

    return


@phantom.playbook_block()
def playbook_solution__case_promotion_lab_5_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("playbook_solution__case_promotion_lab_5_1() called")
    ...
    # call playbook "local/Solution: Case Promotion Lab 5", returns the playbook_run_id
    playbook_run_id = phantom.playbook("local/Solution: Case Promotion Lab 5", container=container, inputs=inputs)
